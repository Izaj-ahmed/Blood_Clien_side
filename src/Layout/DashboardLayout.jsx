                ...
                <div className="drawer-side is-drawer-close:overflow-visible">
                    ...
                    <div className="flex min-h-full flex-col items-start bg-base-200 is-drawer-close:w-14 is-drawer-open:w-64">
                        ...
                        <ul className="menu w-full grow">
                            ...
                            <li>
                                <Link to={'/'}>
                                    <img src={logoImg} alt="Blood Donation" className="w-10 h-10" />
                                </Link>
                            </li>
                            ...
                            <li>
                                <NavLink to="/dashboard/payment-history" className="is-drawer-close:tooltip is-drawer-close:tooltip-right" data-tip="Payments">
                                ...
                                <>
                                    ...
                                    <li>
                                        <NavLink to="/dashboard/my-donation-requests" className="is-drawer-close:tooltip is-drawer-close:tooltip-right" data-tip="My Requests">
                                            <BiSolidDonateBlood className="my-1.5 inline-block size-4" />
                            ...
                            {(role === 'volunteer' || role === 'admin') && (
                                <li>
                                    <NavLink to="/dashboard/all-blood-donation-request" className="is-drawer-close:tooltip is-drawer-close:tooltip-right" data-tip="All Requests">
                            ...
                            {role === 'admin' && (
                                <>
                                    <li>
                                        <NavLink to="/dashboard/all-users" className="is-drawer-close:tooltip is-drawer-close:tooltip-right" data-tip="User Management">
                                    ...
                                    <li>
                                        <NavLink to="/dashboard/manage-volunteers" className="is-drawer-close:tooltip is-drawer-close:tooltip-right" data-tip="Manage Volunteers">
                                            <MdOutlineManageSearch className="my-1.5 inline-block size-4" />
